...
func TestIsSAMLResponsePositive(t *testing.T) {
	//given
	samlResponseData, err := os.ReadFile("responses/samlRespose.html")
	require.Nil(t, err)
...
func TestIsSAMLResponseNegative(t *testing.T) {
	//given
	getToContentData, err := os.ReadFile("responses/getToContent.html")
	require.Nil(t, err)
...
func TestExtractGetToContentUrlNegative(t *testing.T) {
	//given
	samlResposeData, err := os.ReadFile("responses/samlRespose.html")
	require.Nil(t, err)
...
func TestExtractGetToContentUrlDiv(t *testing.T) {
	//given
	getToContentData, err := os.ReadFile("responses/getToContentDiv.html")
	require.Nil(t, err)
...
func TestExtractWinLocHrefUrlPositive(t *testing.T) {
	//given
	winLocHrefData, err := os.ReadFile("responses/winLocHref.html")
	require.Nil(t, err)
...
func TestExtractIDPLoginPassPositive(t *testing.T) {
	//given
	idpLoginPassData, err := os.ReadFile("responses/idpLoginPass.html")
	require.Nil(t, err)
...
func TestExtractIDPLoginPassNegative(t *testing.T) {
	//given
	idpLoginRsaData, err := os.ReadFile("responses/idpLoginRsa.html")
	require.Nil(t, err)
...
func TestExtractPrivilegedIDPLoginPassPositive(t *testing.T) {
	//given
	idpLoginPassData, err := os.ReadFile("responses/privileged_flow/idpLoginPass.html")
	require.Nil(t, err)
	expectedForm := &page.Form{
		URL:    "https://login.authbridge.somegroup.com/nidp/app/login?sid=0&sid=0",
		Method: "POST",
